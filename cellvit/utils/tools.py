...
from cellvit.utils import logger
...
T = TypeVar('T')
def load_typed_object(training_config_path: Path, object_type: Type[T], default: Optional[Type[T]]=None) -> T:
    """
    ...
    :return: The first found instance of *object_type*. If no instance is found and no default object has been given, ValueError is raised
    """
